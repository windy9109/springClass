<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <!-- Vendor JS Files -->
  <script src="<%=request.getContextPath() %>/resources/assets/vendor/purecounter/purecounter.js"></script>
  ...
  <script src="<%=request.getContextPath() %>/resources/assets/vendor/typed.js/typed.min.js"></script>
  <script src="<%=request.getContextPath() %>/resources/assets/vendor/waypoints/noframework.waypoints.js"></script>
