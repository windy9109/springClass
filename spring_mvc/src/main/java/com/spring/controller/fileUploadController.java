...
public class fileUploadController {
	...
	@RequestMapping(value="/fileUploadForm", method = RequestMethod.POST,produces="text/plain;charset=utf-8")
	public ModelAndView uploadByMultiparFile(String title, MultipartFile file, ModelAndView mnv)throws Exception{
	...
	public ModelAndView uploadByMultiparHttpServletRequest(MultipartHttpServletRequest request, ModelAndView mnv)throws Exception{
		
		String title =request.getParameter("title");
		MultipartFile multi = request.getFile("file");
		
		mnv = uploadByMultiparFile(title, multi, mnv);
