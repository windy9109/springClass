	  		...
	  		<div class="row md-2">
	  			...
	  			<div class="col-sm-6">
			        ...
			        <li class="breadcrumb-item">
			        	<a href="list.do">
				        	<i class="fa fa-dashboard"></i>스터디 내용
				        </a>
			        </li>
				...
				<div class="card card-outline card-info">
					...
					<div class="card-body">
						<div class="form-group col-sm-12">
							...
							<input type="text" class="form-control" id="title" readonly disabled value="${studyboard.s_title }" />							
						</div>
						<div class="row">	
							<div class="form-group col-sm-4" >
								<label for="writer">작성자</label>
								<input type="text" class="form-control" id="writer" readonly value="${studyboard.s_writer }"/>
							</div>		
							
							<div class="form-group col-sm-4" >
								<label for="regDate">작성일</label>
								<input type="text" class="form-control" id="regDate" readonly 
									value="<fmt:formatDate value="${studyboard.s_regdate }" pattern="yyyy-MM-dd" />" />
							
							</div>
						</div>		
						<div class="form-group col-sm-12">
							<label for="content">내 용</label>
							<div id="content">${studyboard.s_content }</div>	
						</div>
